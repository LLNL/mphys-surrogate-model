...
for epoch in range(params["training_epochs"]):
    ...
    if epoch % 1 == 0:
        print(
            f"Epoch [{epoch}/{params['training_epochs']}], Train Loss: {losses[-1]:.4f} | Test Loss: {test_losses[-1]:.4f}"
...
plotting.plot_predictions_AE_SINDy(
    test_ids,
    tplt,
    params["latent_dim"],
    params["poly_order"],
...
plotting.plot_latent_trajectories_SINDy(
    params["latent_dim"],
    params["poly_order"],
    model,
    x_test,
