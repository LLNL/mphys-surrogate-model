...
if MODEL_TYPE == "AE-AR" or MODEL_TYPE == "NNdzdt":
    raise NotImplementedError(f"Model type {MODEL_TYPE} not implemented for condensation dataset yet")
...
if MODEL_TYPE == "AE-AR":
    ...
    from training_scripts.condensation.train_ae_sindy import AESINDy, params, train_and_eval
else:
