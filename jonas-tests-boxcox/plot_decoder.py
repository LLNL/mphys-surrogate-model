...
path = parent_directory + "/jonas-tests-boxcox/cp/decoder"
...
plt.tight_layout()
fig_full.savefig(
    parent_directory + "/jonas-tests-boxcox/cp/decoder/compare_vanilla.pdf"
)
fig_split.savefig(parent_directory + "/jonas-tests-boxcox/cp/decoder/compare_split.pdf")
