...
def init_model(device, params):
    ...
    optimal_path = os.path.join(
        ...
        "erf_FFNN_latent3_order(141, 154, 40)_tr1000_"
        "lr0.0030348411572892766_bs8_"
        "weights0.12789450188986579-1.1729901013704414_"
        "a0f49326688d4e69bcc0e9a78da3c870",
    )
    ckpt = torch.load(
        os.path.join(
            optimal_path,
            ...
            "lr0.0030348411572892766_bs8_"
            "weights0.12789450188986579-1.1729901013704414_"
            "a0f49326688d4e69bcc0e9a78da3c870.pth",
        ),
        weights_only=True,
    )
