...
parser.add_argument(
    "-m", "--method", type=str, required=True, help="Name of the cp method to plot"
)
...
for j in range(rep.shape[0]):
    ...
    axs[0].plot(
        ...
        marker="x",
        markersize=0.5,
        label=r"SINDy (representative trajectory), $q_c$",
    )
    ...
    axs[1].plot(
        ...
        marker="x",
        markersize=0.5,
        label=r"SINDy (representative trajectory), $q_r$",
    )
