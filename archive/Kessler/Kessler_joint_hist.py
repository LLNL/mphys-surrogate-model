...
adjustment_factor = (
    0.5  # decrease value for more jagged density, increase for smoother density
)
kde = KernelDensity(
    kernel="epanechnikov", bandwidth=scott_bandwidth * adjustment_factor
)  # define KDE
...
plt.scatter(
    data[:, 0], data[:, 1], s=5, facecolor="white", edgecolor="black", alpha=0.5
)
