...
# First subplot: q_c
axs[0].plot(times[traj_no], states[traj_no][:, 0], color='blue', marker='o', markersize=3, label=r'Exact, $q_c$')
...
# Second subplot: q_r
axs[1].plot(times[traj_no], states[traj_no][:, 1], color='blue', marker='o', markersize=3, label=r'Exact, $q_r$')
