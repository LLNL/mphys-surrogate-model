...
parser.add_argument("-m", "--method", type=str, required=True,
    help="Name of the cp method to test")
...
for i, alpha in enumerate(alphas):
    ...
    print(f'Mean percent of real test trajectories that fall within: {100*np.mean(counter, axis=(0, 1))}')
    print(f'Median percent of real test trajectories that fall within: {100*np.median(counter, axis=(0, 1))}')
    print(f'Standard deviation of percent of real test trajectories that fall within: {100*np.std(counter, axis=(0, 1))}')